            ...
            <nav>
                <div class="edit-status">
                    ...
                    <el-button-group>
                        ...
                        <el-button :disabled="isDisabled" :class="{disable : isDisabled}" type="primary" icon="el-icon-video-play" @click.native="editStatus('unpause')"></el-button>  <!--开始按钮-->
                        <el-button :disabled="isDisabled" :class="{disable : isDisabled}" type="primary" icon="el-icon-video-pause" @click.native="editStatus('pause')"></el-button>  <!--暂停按钮-->
...
export default {
    ...
    computed: {
        ...mapState(['tasks','search', 'selected', 'completeds','discard']),
        isDisabled () {
        ...
        switchSelection() {  // 根据不同页面绑定不同的数据
            ...
            if (currentPage == '/completed') {
                ...
                if (this.selected.length == this.completeds.length) {
                    return true
                }else {
                    return false
                }
                ...
                if (this.selected.length == this.discard.length) {
                    return true
                }else {
                    return false
                }
