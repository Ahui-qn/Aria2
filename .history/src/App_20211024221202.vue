            ...
            <el-menu class="outmost-menu" text-color="#fff" active-text-color="#ffd04b" :router="true" :default-active="currentPath()">
                ...
                <el-submenu index="/settings">
                    ...
                    <el-menu-item-group>
                        ...
                        <el-menu-item index="/setting/http">HTTP设置</el-menu-item>
                        <el-menu-item index="/setting/rpc">RPC设置</el-menu-item>
                        <el-menu-item index="/setting/advanced">高级设置</el-menu-item>
                    </el-menu-item-group>
                </el-submenu>
