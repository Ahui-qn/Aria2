...
export default new Vuex.Store({
    ...
    mutations: {
        sizeSort(state,currentPage) {  // 接收不同页面给不同的数组排序,completeds, discrad
            let a = this.getters.quickSort(state.completeds)
            console.log('a', a)
            console.log(state.discard)
            // if (currentPage == '/completed') {
            //     state.completeds = this.getters.quickSort(state.completeds)
            // }else if (currentPage == '/deleted') {
            //     state.discard = this.getters.quickSort(state.discard)
            // }else {
            //     state.tasks = this.getters.quickSort(state.tasks)
            // }
