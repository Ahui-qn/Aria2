            ...
            <nav>
                <div class="edit-status">
                    ...
                    <el-button-group>
                        ...
                        <el-button type="primary" icon="el-icon-video-play"></el-button>  <!--开始按钮-->
                        <el-button type="primary" icon="el-icon-video-pause"></el-button>  <!--暂停按钮-->
                        <el-button type="primary" icon="el-icon-delete"></el-button>   <!--删除按钮-->
                    </el-button-group>
