            ...
            <el-tab-pane v-for="item in servers" :key="item.id" :label="item.name" :name="item.id">
                <el-form>
                    ...
                    <el-form-item label="HOST" label-width="80px">
                        <el-input :value="item.host"></el-input>
                    </el-form-item>
                    <el-form-item label="端口号" label-width="80px">
                        <el-input-number :value="item.port" :min="1" :max="65535"></el-input-number>
                    </el-form-item>
                    <el-form-item label="密码" label-width="80px">
                        <el-input type="password" show-password :value="item.secret"></el-input>
                    </el-form-item>
                </el-form>
            </el-tab-pane>
        </el-tabs>
