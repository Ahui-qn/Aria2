<template>
    <div class="server">
        ...
        <el-tabs v-model="editableTabsValue" type="card" closable @tab-remove="removeTab">
            <el-tab-pane v-for="server in servers" :key="server.id" :label="server.name || server.host + ':' + server.port" :name="server.id">
                <el-form>
                    ...
                    <el-form-item label="端口号" label-width="80px">
                        <el-input-number :value="server.port"  @change="editNewServer($event, 'port')" :min="1" :max="65535" ></el-input-number>
                    </el-form-item>
                    <el-form-item label="密码" label-width="80px">
                        <el-input type="password" show-password :value="server.secret"  @input="editNewServer($event, 'secret')"></el-input>
                    </el-form-item>
                </el-form>
            </el-tab-pane>
        </el-tabs>
...
export default {
    ...
    methods: {
        ...
        editNewServer(value, type) {    // 修改现有服务器数据
