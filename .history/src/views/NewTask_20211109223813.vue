...
<template>
    <div class="newTask">
        <div class="downloadType">
            ...
            <input type="file"  hidden accept=".torrent"  id="bt" @change="addTorrent">
            <el-dialog
                title="文件列表"
                ...
                <div class="filelist" v-for="info of btInfo" :key="info.length + Math.random()">
                    <span>{{info.name}}</span>
                    <span>{{getFileSize(info)}}</span>
                </div>
            ...
            <input type="file" accept=".metalink"  hidden id="matalink">
