...
function aa (params) {  // parmas是一个对象
...
export default {
    ...
    this.basic = await this.aria2.getGlobalOption()
    this.http = await this.aria2.getGlobalOption()
    this.rpc = await this.aria2.getGlobalOption()
    this.advanced = await this.aria2.getGlobalOption()
