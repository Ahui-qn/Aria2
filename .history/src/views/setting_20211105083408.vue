...
export default {
    ...
    async  mounted() {
        ...
        this.basic = await this.refresh(this.basic, this.aria2)
        this.http = await this.refresh(this.http, this.aria2)
        this.rpc = await this.refresh(this.rpc, this.aria2)
        this.advanced = await this.refresh(this.advanced, this.aria2)
